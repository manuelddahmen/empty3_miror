     ...
     */
    public class P3 extends Representable {
         ...
         */
        public static final P3 X = new P3(1d, 0d, 0d);

        /**
         * Represents a constant point in 3D space.
         */
        public static final P3 Y = new P3(0d, 1d, 0d);

        /**
         * Represents a constant point in 3D space.
         */
        public static final P3 Z = new P3(0d, 0d, 1d);

        /**
         * Represents a constant point in 3D space.
         */
        public static final P3 O0 = new P3(0d, 0d, 0d);

        /**
         * Represents a constant point in 3D space.
         */
        public static final P3 INFINI = new P3(Double.MAX_VALUE, Double.MAX_VALUE, Double.MAX_VALUE);
        /**
         * Represents a constant point in 3D space.
         */
         ...
         */
        public P3(Double x0, Double y0, Double z0, ITexture t) {
            this(x0, y0, z0);
            texture(t);
        }
         ...
         * @param t  The texture associated with the point
         */
        public P3(Double[] x0, ITexture t) {
            int i = 0;
            if (x0.length < 3)
                throw new UnsupportedOperationException("x0.length<3");
            x = x0[0];
         ...
         */
        public P3(@NotNull one.empty3.library.Point3D p0) {
            super();
            for (int i = 0; i < 3; i++)
                set(i, p0.get(i));
            texture(p0.texture);
         ...
         */
        public P3(StructureMatrix<Double> coordArr) {
         ...
         */
        public static P3 n(Double a, Double b, Double c) {
            return new P3(a, b, c);
        }
         ...
         * @return A new Point
         */
        public static P3 random2(Double d) {

            return new P3(((Math.random() - 0.5) * 2 * d), ((Math.random() - 0.5) * 2 * d), ((Math.random() - 0.5) * 2 * d));
        }
         ...
         */
        public static P3 circle(double v) {
            return new P3(Math.cos(v), Math.sin(v), 0.0);
        }
       ...
       /* else
         ...
         */
        public P3 plus(one.empty3.library.Point3D p) {
            P3 p1 = new P3();
            for (int i = 0; i < 3; i++) {
         ...
         */
        public one.empty3.library.P3 plus(Double d) {
            one.empty3.library.P3 p = new P3();
            for (int i = 0; i < 3; i++)
                p.set(i, get(i) + d);
            return p;
        }
         ...
         */
        public one.empty3.library.P3 changeTo(one.empty3.library.Point3D src) {
            for (int i = 0; i < 3; i++)
                set(i, src.get(i));
         ...
         * @return a new Point3D object with the specified coordinates
         */
        public static one.empty3.library.P3 n(double x, double y, double z) {
            return new one.empty3.library.P3(x, y, z);
        }
         ...
         * </pre>
         */
        public class P extends one.empty3.library.P3 {
        }

        @Override
        public boolean equals(Object o) {
            if (this == o) return true;
            if (!(o instanceof one.empty3.library.Point3D || o instanceof P3)) return false;
            ...
            for (int i = 0; i < 3; i++) {
                if (!(get(i) - (point3D.get(i)) < 1E-10))
                    return false;
                if (get(i).equals(Double.NaN) || point3D.coordArr[i].equals(Double.NaN)) {
                    return false;
                }
            }
            return true;
        ...
        public P3 calculerPoint0dT(double t) {
            return this;
        }
