...
public class DistanceApproxLinearC extends DistanceBezier2 {
    private static final int MAX_SUB_ITERE_X = 10;

    public DistanceApproxLinearC(List<Point3D> A, List<Point3D> B, Dimension2D aDimReal, Dimension2D bDimReal) {
