...
public class ChatHumain extends RepresentableConteneur {
    ...
    public ChatHumain(ParametricSurface psGround) {
        ...
        coefficients.setElem(new Point3D(50., -50., 30.), 0);
        coefficients.setElem(new Point3D(50., 100., 30.), 1);
        coefficients.setElem(new Point3D(50., 200., 30.), 2);
    ...
    final static class ChatMovements extends Move {
        ...
        public one.empty3.tests.coursecheval.ChatHumain[] trotte(double seconds, int fps, boolean startsLeftFront, double angleTurn, double distance) {
            ...
            for (int i = 0; i < cheval1.length; i++) {
                ...
                ((CourbeParametriquePolynomiale) cheval1[i].pattes.getElem(0)
                        .getSoulCurve().getElem()).getCoefficients().getElem(1).setY(50 + sin * distance / 2);
                ((CourbeParametriquePolynomiale) cheval1[i].pattes.getElem(1)
                        .getSoulCurve().getElem()).getCoefficients().getElem(1).setY(50 + cos * distance / 2);
                ...
                ((CourbeParametriquePolynomiale) cheval1[i].pattes.getElem(0)
                        .getSoulCurve().getElem()).getCoefficients().getElem(2).setY(50 + sin * distance);
                ((CourbeParametriquePolynomiale) cheval1[i].pattes.getElem(1)
                        .getSoulCurve().getElem()).getCoefficients().getElem(2).setY(50 + cos * distance);
                ((CourbeParametriquePolynomiale) cheval1[i].pattes.getElem(2)
                        .getSoulCurve().getElem()).getCoefficients().getElem(2).setY(-50 + sin * distance);
                ((CourbeParametriquePolynomiale) cheval1[i].pattes.getElem(3)
                        .getSoulCurve().getElem()).getCoefficients().getElem(2).setY(-50 + cos * distance);
        ...
        public one.empty3.tests.coursecheval.ChatHumain[] galope(double seconds, int fps, boolean startsLeftFront, double angleTurn, int distance) {
            one.empty3.tests.coursecheval.ChatHumain[] cheval1 = new one.empty3.tests.coursecheval.ChatHumain[(int) (seconds * fps)];
            for (int i = 0; i < cheval1.length; i++) {
                cheval1[i] = new one.empty3.tests.coursecheval.ChatHumain(cheval.psGround.getElem());
                double sin = Math.sin((4 * 2.0 * Math.PI * i) / cheval1.length);
        ...
        public one.empty3.tests.coursecheval.ChatHumain[] saute(double seconds, int fps, boolean startsLeftFront, double angleTurn, int i) {
            one.empty3.tests.coursecheval.ChatHumain[] cheval1 = new one.empty3.tests.coursecheval.ChatHumain[(int) (seconds * fps)];
